...
class EmailVerifyRecord(models.Model):
    ...
    sendType = models.CharField(choices=(('register','注册'),('forget','找回密码')), max_length=10, verbose_name='Code类型')
    sendTime = models.DateTimeField(auto_now= True, verbose_name='发送日期')
